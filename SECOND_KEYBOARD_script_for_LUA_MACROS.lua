...
--keyboardIdentifier = '0000AAA'
keyboardIdentifier = '18F358B1'
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\luamacros\\samples\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
